STRIPE_SECRET=sk_test_51LmPH9IUDEmPYYbAH89xrjPj9zEptMHFeSi3a9L9gMMsdeEp8uAU4lYf9dR4mt4pBzbxRaDjUFVTVsThi09QLRCY001Fgl5OBi
...
start_front: build_front
	...
	@env STRIPE_KEY=${STRIPE_KEY} STRIPE_SECRET=${STRIPE_SECRET} ./dist/gostripe -port=${WEB_PORT} -dsn="${DSN}" &
...
stop_front:
	...
	@-pkill -SIGTERM -f "gostripe -port=${WEB_PORT}"
